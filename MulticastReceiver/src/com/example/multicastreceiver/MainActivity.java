package com.example.multicastreceiver;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				// call native method to receive multicast, see the source code in /jni/native.c
				receiveMulticast(multicastIp, portNo);
			}
		}).start();
      
	}

	private native int receiveMulticast(String mulitcastIp, String portNo);
